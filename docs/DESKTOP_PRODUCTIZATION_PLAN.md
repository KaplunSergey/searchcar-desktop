...
- `license_source_entitlements` — какие ключи источников разрешены данной лицензии;
...
в подписанный lease, а desktop UI и backend запрещают запуск scan по источнику,
которого в lease нет. Поэтому новый сайт можно добавить в обновлении клиента,
...
- включать набор разрешённых источников в подписанный lease и проверять его в
  Rust-координаторе, backend и UI до запуска scan;
